...
; Init POB Servo board
; Syntax :
; 	InitPOBServo( )
Declare InitPOBServo

; Set servomotor On POB-Servo board.
; Syntax :
; 	SetPOBServo( Servomotor.b, Position.b, Speed.b )
Declare SetPOBServo

; Get servomotor position.
; Syntax :
; 	GetPOBServo( Servomotor.b )
Declare GetPOBServo

; Switch on/off a servomotor On POB-Servo board.
; Syntax :
; 	SwitchOnPOBServo( Servomotor.b )
;       SwitchOffPOBServo( Servomotor.b )
Declare SwitchOnPOBServo
Declare SwitchOffPOBServo
