/* 
 * 
 * Copyright (c) 2006, POB-Technology
 *
...
// uart function
extern void UARTInit_pobbasic( short conf);
...
extern void SetConfigTinyPobProto_pobbasic(void);
...
extern void SendToSapien_pobbasic(char order);

//pob-servo function
extern void InitPOBServo_pobbasic(void);
extern void SetPOBServo_pobbasic(int servo,int position,int speed);
extern int GetPOBServo_pobbasic(int servo);
extern void SwitchOnPOBServo_pobbasic(int servo);
extern void SwitchOffPOBServo_pobbasic(int servo);
